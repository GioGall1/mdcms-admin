<template>
  <a-layout-content >
    <a-breadcrumb style="margin-bottom: 30px;">
      ...
      <a-breadcrumb-item href="/products">Бренды</a-breadcrumb-item>
      <a-breadcrumb-item>Список Брендов</a-breadcrumb-item>
    </a-breadcrumb>
    <div style="margin-bottom: 16px; display: flex; justify-content: space-between;">
      <a-button type="primary">+ Добавить новый бренд</a-button>
